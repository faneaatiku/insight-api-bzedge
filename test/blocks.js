...
describe('Blocks', function() {
  ...
  describe('#getBlockReward', function() {
    ...
    it('should give a block reward of 12500 * 1e8 for block before first halvening', function() {
      blocks.getBlockReward(100000).should.equal(12500 * 1e8);
    });

    it('should give a block reward of 1250 * 1e8 for block between first and second halvenings', function() {
      blocks.getBlockReward(373011).should.equal(1250 * 1e8);
    });

    it('should give a block reward of 625 * 1e8 for block between second and third halvenings', function() {
      blocks.getBlockReward(500000).should.equal(625 * 1e8);
    });
  });
});
